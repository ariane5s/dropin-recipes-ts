...
class DROPinAPI {
    ...
    static createCompany(name, slug, administrators) {
    ...
    static updateCompany(name, slug, administrators) {
        return this.request(FetchMethod.POST, `companies/${slug}`, {}, {
            name,
            slug,
            administrators
        });
    }
    static deleteCompany(slug) {
        return this.request(FetchMethod.DELETE, `companies/${slug}`);
    }
    static createCollection(name, slug, fields) {
        return this.request(FetchMethod.PUT, "collections", {}, {
            name,
            slug,
            administrators
        });
    ...
    static createRecipe(name, slug, company, authors, administrators) {
    ...
    static updateRecipe(name, slug, authors, administrators) {
        return this.request(FetchMethod.POST, `recipes/${slug}`, {}, {
            name,
            slug,
            authors,
            administrators
    ...
    static deleteRecipe(slug) {
        return this.request(FetchMethod.DELETE, `recipes/${slug}`);
    }
}
